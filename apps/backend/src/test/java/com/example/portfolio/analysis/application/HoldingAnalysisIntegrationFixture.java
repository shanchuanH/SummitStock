...
abstract class HoldingAnalysisIntegrationFixture extends MySqlIntegrationTest {
    ...
    void seedHoldingEvidence() {
        ...
        update(
                ...
                VALUES
                (UUID_TO_BIN('99010000-0000-0000-0000-000000000001'),UUID_TO_BIN('93000000-0000-0000-0000-000000000001'),YEAR(CURRENT_DATE),'ANNUAL',CURRENT_DATE,CURRENT_DATE,'r5-fixture','10-K','TEST','HEALTHY',UTC_TIMESTAMP(6)),
                (UUID_TO_BIN('99010000-0000-0000-0000-000000000011'),UUID_TO_BIN('93000000-0000-0000-0000-000000000001'),YEAR(CURRENT_DATE),'QUARTERLY',CURRENT_DATE,CURRENT_DATE,'q1-fixture','10-Q','TEST','HEALTHY',UTC_TIMESTAMP(6)),
                (UUID_TO_BIN('99010000-0000-0000-0000-000000000012'),UUID_TO_BIN('93000000-0000-0000-0000-000000000001'),YEAR(DATE_SUB(CURRENT_DATE,INTERVAL 3 MONTH)),'QUARTERLY',DATE_SUB(CURRENT_DATE,INTERVAL 3 MONTH),DATE_SUB(CURRENT_DATE,INTERVAL 2 MONTH),'q2-fixture','10-Q','TEST','HEALTHY',UTC_TIMESTAMP(6)),
                (UUID_TO_BIN('99010000-0000-0000-0000-000000000013'),UUID_TO_BIN('93000000-0000-0000-0000-000000000001'),YEAR(DATE_SUB(CURRENT_DATE,INTERVAL 6 MONTH)),'QUARTERLY',DATE_SUB(CURRENT_DATE,INTERVAL 6 MONTH),DATE_SUB(CURRENT_DATE,INTERVAL 5 MONTH),'q3-fixture','10-Q','TEST','HEALTHY',UTC_TIMESTAMP(6)),
                (UUID_TO_BIN('99010000-0000-0000-0000-000000000014'),UUID_TO_BIN('93000000-0000-0000-0000-000000000001'),YEAR(DATE_SUB(CURRENT_DATE,INTERVAL 9 MONTH)),'QUARTERLY',DATE_SUB(CURRENT_DATE,INTERVAL 9 MONTH),DATE_SUB(CURRENT_DATE,INTERVAL 8 MONTH),'q4-fixture','10-Q','TEST','HEALTHY',UTC_TIMESTAMP(6))
                """);
        update(
                """
