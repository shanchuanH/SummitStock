...
final class HoldingEvidenceFixtures {
    ...
    static HoldingEvidence evidence(String symbol, String assetType, HoldingClassification classification) {
        ...
        return new HoldingEvidence(
                ...
                new HoldingEvidence.FundamentalSnapshot(true, EvidenceQuality.HEALTHY, now),
                new HoldingEvidence.ValuationSnapshot(true, now),
                new HoldingEvidence.EarningsEvent(true, now.plusSeconds(86400 * 20L), "NORMAL"),
                ...
                new HoldingEvidence.StopEvidence(new BigDecimal("105"), new BigDecimal("106"), false, false),
