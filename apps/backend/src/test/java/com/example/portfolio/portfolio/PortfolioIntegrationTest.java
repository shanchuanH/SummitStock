...
class PortfolioIntegrationTest extends MySqlIntegrationTest {
    ...
    private void seedPositionIntelligence() {
        ...
        update(
                ...
                VALUES (UUID_TO_BIN('30000000-0000-0000-0000-000000000001'), UUID_TO_BIN('%s'), '2.0.0-draft', 100, 4, 91, 90, 90, 94, 96, 91, TRUE, JSON_ARRAY('STOP.CLOSE_CONFIRMED.001'), 'HEALTHY', REPEAT('c',64), UTC_TIMESTAMP(6), UTC_TIMESTAMP(6))
                """
                        .formatted(OWNER_POSITION));
        update(
                """
                ...
                VALUES (UUID_TO_BIN('30000000-0000-0000-0000-000000000020'), UUID_TO_BIN('%s'), '2.0.0-draft', 'HEALTHY', TRUE, 'IMPROVING', 'CONFIRMED', TRUE, 0, 'ADD_1_PERCENT_STARTER', JSON_ARRAY(), REPEAT('d',64), UTC_TIMESTAMP(6), '2099-01-01', UTC_TIMESTAMP(6))
                """
                        .formatted(OWNER_POSITION));
        update(
                """
                ...
                VALUES (UUID_TO_BIN('30000000-0000-0000-0000-000000000030'), UUID_TO_BIN('%s'), '2.0.0-draft', 10, '2099-01-01', -0.08, 0.06, 0.10, 1.5, 'HOLD_THROUGH_EVENT', JSON_ARRAY('EARNINGS.QUALITY.001'), REPEAT('e',64), UTC_TIMESTAMP(6), '2099-01-01', UTC_TIMESTAMP(6))
                """
                        .formatted(OWNER_POSITION));
        update(
                """
    ...
    private void recommendation(String id, String priority, String action, int suffix) {
        update(
                ...
                VALUES (UUID_TO_BIN('%s'), UUID_TO_BIN('%s'), UUID_TO_BIN('%s'), '2.0.0-draft', '%s', '%s',
