...
class PortfolioIntegrationTest extends MySqlIntegrationTest {
    ...
    private void seedPositionIntelligence() {
        update(
                """
                INSERT IGNORE INTO financial_period (id,instrument_id,fiscal_year,fiscal_quarter,period_type,start_date,end_date,filed_at,accession_number,form_type,source,quality,created_at)
        ...
        update(
                """
                INSERT IGNORE INTO financial_metric_snapshot (id,instrument_id,period_id,metric_code,value_decimal,unit,calculation_version,source_concepts,mapping_version,aggregation_method,quality,evidence_checksum,data_as_of,created_at)
        ...
        update(
                """
                INSERT IGNORE INTO estimate_revision_snapshot (id,instrument_id,period_end,horizon,revision_7d,revision_30d,revision_90d,overall_revision,eps_change_7d,eps_change_30d,eps_change_90d,analyst_count,quality,evidence_checksum,data_as_of,created_at)
        ...
        update(
                """
                INSERT IGNORE INTO valuation_metric_history (id,instrument_id,market_date,trailing_pe,forward_pe,ev_sales,fcf_yield,price_sales,market_cap,source,quality,evidence_checksum,data_as_of,created_at)
        ...
        update(
                """
                INSERT IGNORE INTO valuation_assessment_snapshot (id,instrument_id,valuation_state,confidence,own_history_percentile_3y,own_history_percentile_5y,relative_valuation,growth_adjusted_valuation,observation_count,quality,strategy_version,config_hash,evidence_checksum,data_as_of,created_at)
